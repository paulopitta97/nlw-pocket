...
export default function Market() {
    ...
    async function handleOpenCamera() {
        try {
            ...
            if(!granted){
                return Alert.alert("Camêra", "Você precisa habilitar o uso da câmera.")
            }
            qrLock.current = false
            setIsVisibleCameraModal(true)
        } catch( error ) {
            console.log( error )
            return Alert.alert("Camêra", "Não foi possível utilizar a câmera.")
        }
    }
